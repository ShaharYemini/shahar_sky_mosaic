// PRNG based on seed (uses a simple Linear Congruential Generator)
...
function displayImages(seed, totalImages) {
  const container = document.getElementById('banana');
  ...
  for (let i = 1; i <= totalImages; i++) {
    ...
    images.push(`<img class="image" src="img/${paddedNum}.jpg" draggable="false" />`);
  }

  // Shuffle the images array with seeded randomness
  const rng = seededRandom(seed);
  shuffleArray(images, rng);
